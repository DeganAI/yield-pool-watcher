            ...
            "accepts": [{
                ...
                "outputSchema": {
                    "input": {
                        ...
                        "bodyType": "json",
                        "bodyFields": {
                            "protocol_ids": {"type": "array", "required": True, "description": "DeFi protocols to monitor"},
                            "pools": {"type": "array", "required": True, "description": "Pool addresses to watch"},
                            "chain": {"type": "number", "required": True, "description": "Target blockchain chain ID"}
                        }
                    },
                    "output": {"type": "object", "description": "APY and TVL tracking with sharp change alerts"}
                }
            }]
        }
    )
